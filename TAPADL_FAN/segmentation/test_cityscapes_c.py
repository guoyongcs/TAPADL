...
def main():
    ...
    digital_list = ['contrast', 'jpeg_compression', 'saturate', 'brightness']
    weather_list = ['snow', 'fog', 'frost', 'spatter']
    name_list = blur_list + noise_list + digital_list + weather_list
