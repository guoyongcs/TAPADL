...
def my_load_checkpoint(
    ...
    if 'state_dict' in checkpoint:
        state_dict = checkpoint['state_dict_ema'] if load_ema else checkpoint['state_dict']
    else:
...
class TAPFANBlock(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0., drop_path=0., norm_layer=nn.LayerNorm, eta=1., num_scales=1):
        super().__init__()
        self.norm1 = norm_layer(dim)
...
class FAN(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12, 
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=False, feat_downsample=False, use_checkpoint=False, load_ema=False, num_scales=1):
        super().__init__()
        img_size = to_2tuple(img_size)
        ...
        self.blocks = nn.ModuleList([
            build_block(
                ...
                attn_drop=attn_drop_rate, drop_path=drop_path_rate, norm_layer=norm_layer, eta=eta, num_scales=num_scales)
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            ...
            my_load_checkpoint(self, pretrained, map_location='cpu', strict=False, logger=logger, load_ema=self.load_ema)
    ...
    def forward_features(self, x):
        ...
        return outs, attn_list

    def forward(self, x):
        x, attn_list = self.forward_features(x)
        if self.training:
            return x, attn_list
        else:
            return x
...
class tap_fan_tiny_8_p4_hybrid(FAN):
    def __init__(self, **kwargs):
        ...
        super(tap_fan_tiny_8_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=1000, embed_dim=192, depth=depth, backbone=backbone, out_idx=7,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, load_ema=True, num_scales=4)

@BACKBONES.register_module()
class tap_fan_small_12_p4_hybrid(FAN):
    def __init__(self, **kwargs):
        depth = 10
        model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
        backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
        super(tap_fan_small_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=1000, embed_dim=384, depth=depth, backbone=backbone, out_idx=9,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, feat_downsample=False, load_ema=True, num_scales=4)

@BACKBONES.register_module()
class tap_fan_base_16_p4_hybrid(FAN):
    def __init__(self, **kwargs):
        depth = 16
        model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
        backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
        super(tap_fan_base_16_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=1000, embed_dim=448, depth=depth, backbone=backbone, out_idx=15, feat_downsample=False,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, load_ema=False, num_scales=4)

@BACKBONES.register_module()
class tap_fan_large_16_p4_hybrid(FAN):
    def __init__(self, **kwargs):
        depth = 22
        model_args = dict(depths=[3, 5], dims=[128, 256, 512, 1024], use_head=False)
        backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
        super(tap_fan_large_16_p4_hybrid, self).__init__(
...
# FAN-ViT Models
@BACKBONES.register_module()
class tap_fan_small_12_p16_224(FAN):
    def __init__(self, **kwargs):
        depth = 12
        super(tap_fan_small_12_p16_224, self).__init__(
...
@BACKBONES.register_module()
class tap_fan_base_18_p16_224(FAN):
    def __init__(self, **kwargs):
        depth = 18
        super(tap_fan_base_18_p16_224, self).__init__(
